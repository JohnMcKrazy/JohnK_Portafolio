    ...
    const infoSoftware = [
        {
            ...
            tech_info: "Adobe Illustrator es un programa para diseño creado por Adobe Systems y es el primer programa oficial de su tipo lanzado por la compañía, definiendo en cierta manera el lenguaje gráfico contemporáneo mediante el dibujo vectorial.",
        ...
        },
        {
            ...
            tech_info: "Adobe InDesign (ID) es una aplicación para la composición digital de páginas desarrollada por la compañía Adobe Systems y dirigida a maquetadores profesionales",
        ...
        },
        {
            ...
            tech_info: "Adobe Xd  herramienta de creación de prototipos y diseño de interfaz.",
        ...
        },
        {
            ...
            tech_info:
                "CSS (siglas en inglés de Cascading Style Sheets), en español «Hojas de estilo en cascada», es un lenguaje de diseño gráfico para definir y crear la presentación de un documento estructurado escrito en un lenguaje de marcado.2​ Es muy usado para establecer el diseño visual en interfaces de usuario escritas en HTML",
        ...
        },
        {
            ...
            tech_info: "Sass es un metalenguaje de Hojas de Estilo en Cascada (CSS).",
        ...
        },
        {
            ...
            tech_info: "GitHub es una forja (plataforma de desarrollo colaborativo) para alojar proyectos utilizando el sistema de control de versiones Git. Se utiliza principalmente para la creación de código fuente de programas de ordenador.",
        ...
        },
        {
            ...
            tech_info: "Python es un lenguaje de alto nivel de programación interpretado cuya filosofía hace hincapié en la legibilidad de su código, se utiliza para desarrollar aplicaciones de todo tipo",
            icon: '<div class="icon_container"><svg class="python_icon_svg tech_icon_card" data-name="python_icon_svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32"><title>Python</title><g transform="matrix(.1617 0 0 .158089 -107.53764 -81.66187)"><path class="cls-1" d="M716.255 544.487c0-13.623 3.653-21.034 23.822-24.563 13.693-2.4 31.25-2.7 47.627 0 12.935 2.135 23.822 11.77 23.822 24.563v44.945c0 13.182-10.57 23.98-23.822 23.98h-47.627c-16.164 0-29.787 13.782-29.787 29.363v21.564h-16.376c-13.852 0-21.917-9.988-25.305-23.964-4.57-18.776-4.376-29.963 0-47.945 3.794-15.687 15.917-23.964 29.77-23.964h65.52v-6h-47.645v-17.98z"/><path class="cls-2" d="M811.527 688.32c0 13.623-11.823 20.523-23.822 23.964-18.052 5.188-32.54 4.394-47.627 0-12.6-3.67-23.822-11.17-23.822-23.964v-44.945c0-12.935 10.782-23.98 23.822-23.98h47.627c15.864 0 29.787-13.71 29.787-29.963v-20.964h17.858c13.87 0 20.4 10.305 23.822 23.964 4.764 18.97 4.976 33.157 0 47.945-4.817 14.364-9.97 23.964-23.822 23.964H763.9v6h47.627v17.98z"/><path class="cls-3" d="M728.166 541.505c0-4.976 3.988-9 8.93-9 4.923 0 8.93 4.023 8.93 9 0 4.96-4.006 8.982-8.93 8.982-4.94 0-8.93-4.023-8.93-8.982zm53.59 149.798c0-4.96 4.006-8.982 8.93-8.982 4.94 0 8.93 4.023 8.93 8.982 0 4.976-3.988 9-8.93 9-4.923 0-8.93-4.023-8.93-9z"/></g></svg></div>',
        },
        {
            db_name: "react",
            tech_name: "React",
